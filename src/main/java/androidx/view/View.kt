 ...
 * ```
 *
 * Setting this value to true set the visibility to [View.VISIBLE], false to [View.GONE].
 *
 * ```
 * view.isVisible = true
 * ```
 ...
 * ```
 *
 * Setting this value to true set the visibility to [View.INVISIBLE], false to [View.VISIBLE].
 *
 * ```
 ...
 * ```
 *
 * Setting this value to true set the visibility to [View.GONE], false to [View.VISIBLE].
 *
 * ```
 * view.isGone = true
 * ```
